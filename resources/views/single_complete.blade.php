                    ...
                    <div class="wrapper">
                        <div class="container">
                            ...
                            <div class="form-group">
                                <h2 class="text-lg font-semibold py-12 mb-2">*Is this image any of the following? If so, check
                                    which applies and DO NOT add any further attributes to the image.</h2>
                                <div class="flex justify-between mb-5 flex-row">
                                    <div class="min-w-60">
                                        <div>
                                            <input type="checkbox" id="xa" name="not_humen" value="not_humen"
                                                class="mr-2" @if ($image->not_humen == 'Yes') checked @endif
                                                disabled> Not a real human (xa)
                                            <br>
                                            ...
                                            <input type="checkbox" id="xb" name="no_face" value="no_face"
                                                ...
                                                disabled> Does not contain a face (xb)
                                            <br>
                                        </div>
                                    </div>
                                    <div class="min-w-60">
                                        <div>
                                            <input type="checkbox" id="xc" name="not_portrait"
                                                ...
                                                @if ($image->not_portrait == 'Yes') checked @endif disabled> Not a
                                            portrait <b class="font-bold">(xc)</b>
                                            <br>
                                            <input type="checkbox" id="xd" name="black_white" value="black_white"
                                                class="mr-2" @if ($image->black_white == 'Yes') checked @endif
                                                disabled> Greyscale/Black and White <b class="font-bold">(xd)</b>
                                            <br>
                                        </div>
                                    </div>
                                    <div class="min-w-60">
                                        <div>
                                            <input type="checkbox" id="xe" name="unvaried_background"
                                                ...
                                                @if ($image->unvaried_background == 'Yes') checked @endif disabled> Unvaried
                                            Background <b class="font-bold">(xe)</b>
                                            <br>
                                            <input type="checkbox" name="background_plain" value="background_plain"
                                                id="xf" class="mr-2"
                                                @if ($image->background_plain == 'Yes') checked @endif disabled> Portrait
                                    ...
                                    <div class="min-w-60">
                                        <div>
                                            <input type="checkbox" id="xg" name="multiple_people"
                                                ...
                                                @if ($image->multiple_people == 'Yes') checked @endif disabled> Multiple
                                            People in Image <b class="font-bold">(xg)</b>
                                            <br>
                                            <input type="checkbox" id="xh" name="image_blank" value="image_blank"
                                                class="mr-2" @if ($image->image_blank == 'Yes') checked @endif
                                                disabled> Image Link Blank/Blank Image <b class="font-bold">(xh)</b>
                                            <br>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="p-4 border rounded-lg shadow">
                                            ...
                                            <div>
                                                <input type="checkbox" name="front_view" value="front_view"
                                                    class="mr-2" @if ($image->front_view == 'Yes') checked @endif
                                                    disabled> Front View<br>
                                                <input type="checkbox" name="side_view" value="side_view"
                                                    class="mr-2" @if ($image->side_view == 'Yes') checked @endif
                                                    disabled> Side View<br>
                                                <input type="checkbox" name="varied_background"
                                                    value="varied_background" class="mr-2"
                                                    @if ($image->varied_background == 'Yes') checked @endif disabled> Varied
                                                Background<br>
                                                <input type="checkbox" name="photo_of_people" value="photo_of_people"
                                                    class="mr-2" @if ($image->photo_of_people == 'Yes') checked @endif
                                                    disabled> Photo of people<br>
                                                <input type="checkbox" name="not_photo_of_people"
                                                    value="not_photo_of_people" class="mr-2"
                                                    @if ($image->not_photo_of_people == 'Yes') checked @endif disabled> Not
                                                photo of people<br>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 border rounded-lg shadow">
                                            ...
                                            <div>
                                                <input type="checkbox" name="dark_glasses" value="dark_glasses"
                                                    class="mr-2" @if ($image->dark_glasses == 'Yes') checked @endif
                                                    disabled> Dark Glasses<br>
                                                <input type="checkbox" name="frames_covering_eyes"
                                                    value="frames_covering_eyes" class="mr-2"
                                                    @if ($image->frames_covering_eyes == 'Yes') checked @endif disabled> Frames
                                                covering eyes<br>
                                                <input type="checkbox" name="frames_too_heavy"
                                                    value="frames_too_heavy" class="mr-2"
                                                    @if ($image->frames_too_heavy == 'Yes') checked @endif disabled> Frames
                                                too heavy<br>
                                                <input type="checkbox" name="hair_across_eyes"
                                                    value="hair_across_eyes" class="mr-2"
                                                    @if ($image->hair_across_eyes == 'Yes') checked @endif disabled> Hair
                                                Across eyes<br>
                                                <input type="checkbox" name="wearing_hat_cap" value="wearing_hat_cap"
                                                    class="mr-2" @if ($image->wearing_hat_cap == 'Yes') checked @endif
                                                    disabled> Wearing Hat/Cap<br>
                                                <input type="checkbox" name="veil_scarf_over_face"
                                                    value="veil_scarf_over_face" class="mr-2"
                                                    @if ($image->veil_scarf_over_face == 'Yes') checked @endif disabled>
                                                Veil/Scarf over face<br>
                                                <input type="checkbox" name="shadow_behind_the_head_portrait"
                                                    value="shadow_behind_the_head_portrait" class="mr-2"
                                                    @if ($image->shadow_behind_the_head_portrait == 'Yes') checked @endif disabled> Shadow
                                        ...
                                        <div class="p-4 border rounded-lg shadow">
                                            ...
                                            <div>
                                                <input type="checkbox" name="eyes_closed" value="eyes_closed"
                                                    class="mr-2" @if ($image->eyes_closed == 'Yes') checked @endif
                                                    disabled> Eyes Closed<br>
                                                <input type="checkbox" name="looking_away" value="looking_away"
                                                    class="mr-2" @if ($image->looking_away == 'Yes') checked @endif
                                                    disabled> Looking away<br>
                                                <input type="checkbox" name="mouth_open" value="mouth_open"
                                                    class="mr-2" @if ($image->mouth_open == 'Yes') checked @endif
                                                    disabled> Mouth Open<br>
                                                <input type="checkbox" name="red_eyes" value="red_eyes"
                                                    class="mr-2" @if ($image->red_eyes == 'Yes') checked @endif
                                                    disabled> Red Eyes<br>
                                                <input type="checkbox" name="unnatural_skintone"
                                                    value="unnatural_skintone" class="mr-2"
                                                    @if ($image->unnatural_skintone == 'Yes') checked @endif disabled>
                                                Unnatural skintone<br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
